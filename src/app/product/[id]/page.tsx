...
export default async function ProductPage({params}: ProductPageProps) {
    ...
    return (
        <div className="flex gap-10 justify-center w-100 h-full bg-gray-50 absolute w-full top-15 left-0 max-md:flex-col max-md:items-center max-md:gap-2 ">
            ...
            <div className="flex flex-col gap-4 my-8 text-white max-md:my-0">
                ...
                <div className="flex gap-2 items-center">
                    <p className="text-md text-center text-black ">Adicionar ao Carrinho</p><AddCart product={product}/>
                </div>
            </div>
        </div>
    )
