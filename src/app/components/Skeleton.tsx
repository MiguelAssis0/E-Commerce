...
export default function Skeleton({isLoading}: {isLoading?: boolean}) {
    return(
        ...
        <div className={clsx('flex flex-col shadow-lg h-96 bg-slate-800 p-5 text-gray-300 ',
            {
                'relative overflow-hidden before:absolute before:inset-0 before:translate-x-full before:animate-[shimmer_1.3s_infinite] before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent': isLoading
            }
        )}>
